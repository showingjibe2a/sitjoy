...
class WSGIApp(
    ...
    def __init__(self):
        ...
        self.PAGE_PERMISSION_DEFAULT_DENIED = frozenset({
            ...
            'system_dingtalk_notify_management',
        })
        ...
        label_map = {
            ...
            'system_dingtalk_notify_management': '钉钉通知配置',
            'gallery': '图片管理',
            'spec_main_image_management': '规格主图管理',
        ...
        self.PAGE_PERMISSION_GROUPS = [
            ...
            {'key': 'gallery', 'title': '图片管理', 'page_keys': ['gallery', 'spec_main_image_management', 'image_type_management', 'aplus_management']},
