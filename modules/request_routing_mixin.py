...
API_PERMISSION_MAP = {
    ...
    '/api/gallery-image-channel': 'gallery',
    '/api/gallery-channel-image-upload': 'gallery',
    '/api/gallery-batch-delete': 'gallery',
    '/api/gallery-dup-check': 'gallery',
    '/api/spec-main-images': 'spec_main_image_management',
    '/api/spec-main-image-variant': 'spec_main_image_management',
    '/api/spec-main-image-variant-delete': 'spec_main_image_management',
    '/api/spec-main-image-variants-batch-validate': 'spec_main_image_management',
    '/api/spec-main-image-variants-batch-delete': 'spec_main_image_management',
    ...
    '/api/fabric-import-by-path': 'fabric_management',
    '/api/image-picker': 'fabric_management',
    ...
    '/api/amazon-ad-target': 'amazon_ad_delivery_management',
    '/api/amazon-ad-target-template': 'amazon_ad_delivery_management',
    '/api/amazon-ad-target-import': 'amazon_ad_delivery_management',
    '/api/amazon-ad-delivery': 'amazon_ad_delivery_management',
    '/api/amazon-ad-delivery-template': 'amazon_ad_delivery_management',
    '/api/amazon-ad-delivery-import': 'amazon_ad_delivery_management',
    '/api/amazon-ad-product': 'amazon_ad_product_management',
    '/api/amazon-ad-product-template': 'amazon_ad_product_management',
    '/api/amazon-ad-product-import': 'amazon_ad_product_management',
    ...
    '/api/order-product-package-class-batch': 'order_product_management',
    '/api/order-product-main-images': 'order_product_management',
    '/api/order-product-main-images-upload': 'order_product_management',
    '/api/order-product-main-images-replace': 'order_product_management',
    '/api/order-product-main-images-import-by-path': 'order_product_management',
    '/api/logistics-factory': 'logistics_factory_management',
    '/api/logistics-forwarder': 'logistics_in_transit_management',
    ...
    '/api/dingtalk-notify': 'home',
    '/api/dingtalk-group': 'system_dingtalk_notify_management',
    '/api/dingtalk-notify-binding': 'system_dingtalk_notify_management',
    '/api/dingtalk-page-notify-binding': 'system_dingtalk_notify_management',
    ...
    '/api/sales-product-amazon-inventory-export': 'sales_product_management',
    '/api/sales-product-wayfair-inventory-export': 'sales_product_management',
    '/api/sales-product-inventory-export-preview': 'sales_product_management',
    '/api/fabric-inventory-share': 'sales_product_management',
    '/api/sales-product-import': 'sales_product_management',
    '/api/sales-product-spec-suggest': 'sales_product_management',
    '/api/sales-product-variant-prefill': 'sales_product_management',
    ...
    '/api/commission-rules': 'sales_product_management',
...
PAGE_TEMPLATE_MAP = {
    ...
    '/spec-main-image-management': ('templates/spec_main_image_management.html', 'spec_main_image_management'),
    ...
    '/system-dingtalk-notify-management': ('templates/system_dingtalk_notify_management.html', 'system_dingtalk_notify_management'),
    ...
    '/amazon-ad-target-management': ('templates/amazon_ad_delivery_management.html', 'amazon_ad_delivery_management'),
...
API_ROUTE_MAP = {
    ...
    '/api/todo-type': ('method', 'handle_todo_type_api'),
    ...
    '/api/gallery-image-channel': ('method', 'handle_gallery_image_channel_api'),
    '/api/gallery-channel-image-upload': ('start', 'handle_gallery_channel_image_upload_api'),
    ...
    '/api/amazon-ad-target': ('method', 'handle_amazon_ad_target_api'),
    '/api/amazon-ad-target-template': ('method', 'handle_amazon_ad_target_template_api'),
    '/api/amazon-ad-target-import': ('method', 'handle_amazon_ad_target_import_api'),
    '/api/amazon-ad-delivery': ('method', 'handle_amazon_ad_target_api'),
    '/api/amazon-ad-delivery-template': ('method', 'handle_amazon_ad_target_template_api'),
    '/api/amazon-ad-delivery-import': ('method', 'handle_amazon_ad_target_import_api'),
    '/api/amazon-ad-product': ('method', 'handle_amazon_ad_product_api'),
    '/api/amazon-ad-product-template': ('method', 'handle_amazon_ad_product_template_api'),
    '/api/amazon-ad-product-import': ('method', 'handle_amazon_ad_product_import_api'),
    ...
    '/api/order-product-package-class-batch': ('method', 'handle_order_product_package_class_batch_api'),
    '/api/order-product-main-images': ('method', 'handle_order_product_main_images_api'),
    '/api/order-product-main-images-upload': ('start', 'handle_order_product_main_images_upload_api'),
    '/api/order-product-main-images-replace': ('start', 'handle_order_product_main_images_replace_api'),
    '/api/order-product-main-images-import-by-path': ('method', 'handle_order_product_main_images_import_by_path_api'),
    ...
    '/api/dingtalk-notify': ('method', 'handle_dingtalk_notify_api'),
    '/api/dingtalk-group': ('method', 'handle_dingtalk_group_api'),
    '/api/dingtalk-notify-binding': ('method', 'handle_dingtalk_notify_binding_api'),
    '/api/dingtalk-page-notify-binding': ('method', 'handle_dingtalk_page_notify_binding_api'),
    ...
    '/api/sales-product-amazon-inventory-export': ('method', 'handle_sales_product_amazon_inventory_export_api'),
    '/api/sales-product-wayfair-inventory-export': ('method', 'handle_sales_product_wayfair_inventory_export_api'),
    '/api/sales-product-inventory-export-preview': ('method', 'handle_sales_product_inventory_export_preview_api'),
    '/api/fabric-inventory-share': ('method', 'handle_fabric_inventory_share_api'),
    ...
    '/api/sales-product-spec-suggest': ('method', 'handle_sales_product_spec_suggest_api'),
    '/api/sales-product-variant-prefill': ('method', 'handle_sales_product_variant_prefill_api'),
    ...
    '/api/commission-rules': ('method', 'handle_commission_rules_api'),
    ...
    '/api/sales-forecast': ('method', 'handle_sales_forecast_api'),
    '/api/sales-forecast-bulk-update': ('method', 'handle_sales_forecast_bulk_update_api'),
    ...
    '/api/fabric-import-by-path': ('method', 'handle_fabric_import_by_path_api'),
    '/api/image-picker': ('method', 'handle_image_picker_api'),
...
class RequestRoutingMixin:
    ...
    def _validate_api_permission(self, path, environ, start_response):
        ...
        dual_access = {
            ...
            '/api/browse': (
                'gallery', 'sales_product_management', 'order_product_management',
                'fabric_management', 'spec_main_image_management',
            ),
            '/api/image-picker': (
                'fabric_management', 'sales_product_management',
                'order_product_management', 'spec_main_image_management',
            ),
            '/api/fabric-import-by-path': ('fabric_management', 'gallery'),
            ...
            '/api/fabric-inventory-share': ('sales_product_management', 'product_management'),
            '/api/gallery-image-channel': ('gallery', 'sales_product_management', 'order_product_management', 'fabric_management', 'spec_main_image_management'),
            '/api/gallery-channel-image-upload': ('gallery', 'sales_product_management', 'order_product_management', 'fabric_management', 'spec_main_image_management'),
