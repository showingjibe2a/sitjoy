...
API_ROUTE_MAP = {
    ...
    '/api/amazon-ad-delivery-template': ('method', 'handle_amazon_ad_delivery_template_api'),
    '/api/amazon-ad-delivery-import': ('method', 'handle_amazon_ad_delivery_import_api'),
