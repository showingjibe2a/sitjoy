...
API_PERMISSION_MAP = {
    ...
    '/api/sales-product-performance': 'sales_product_management',
    '/api/sales-product-performance-template': 'sales_product_management',
    '/api/sales-product-performance-import': 'sales_product_management',
    '/api/sales-product-performance-dashboard': 'sales_product_management',
...
PAGE_TEMPLATE_MAP = {
    ...
    '/sales-product-performance-management': ('templates/sales_product_performance_management.html', 'sales_product_management'),
