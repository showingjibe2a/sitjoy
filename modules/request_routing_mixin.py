...
API_PERMISSION_MAP = {
    ...
    '/api/amazon-ad-target': 'amazon_ad_target_management',
    '/api/amazon-ad-target-template': 'amazon_ad_target_management',
    '/api/amazon-ad-target-import': 'amazon_ad_target_management',
    '/api/amazon-ad-delivery': 'amazon_ad_target_management',
    '/api/amazon-ad-delivery-template': 'amazon_ad_target_management',
    '/api/amazon-ad-delivery-import': 'amazon_ad_target_management',
...
PAGE_TEMPLATE_MAP = {
    ...
    '/amazon-ad-target-management': ('templates/amazon_ad_target_management.html', 'amazon_ad_target_management'),
    '/amazon-ad-delivery-management': ('templates/amazon_ad_target_management.html', 'amazon_ad_target_management'),
